pipeline {
    ...
    environment {
        ...
        DOCKERHUB_REPO = "priyanka0894/boardgame-listing"
    ...
    stages {
        ...
        stage('Deploy App to K8s') {
            steps {
                sh '''
                kubectl apply -f k8s/app/deployment.yaml --validate=false
                kubectl apply -f k8s/app/service.yaml --validate=false
